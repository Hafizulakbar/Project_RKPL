...
<body style="font-family: 'Poppins', sans-serif;" background="assets/foto/background-dash.png">
                ...
                <ul class="navbar-nav  ms-auto ">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            ...
                            <li><a class="dropdown-item" href="/dashboard">Lihat Keluhan</a></li>
                            <li><a class="dropdown-item" href="/createStory">Buat Keluhan</a></li>
                            <li>
    ...
    <div class="jumbotron" style="background-image :url(assets/foto/jumbotron.png);">
        <div class="container">
            ...
            <p class="lead text-white">Dentalk adalah situs web dimana kamu bisa️ memberikan seputar keluhanmu
            kepada dokter melalui sebuah situs web, yang nantinya dokter akan menanggapi keluhanmu tersebut
            </p>
            <a class=" btn-ungu btn shadow-sm border-5 py-2 px-3 mb-2 fw-medium text-white" href="/createStory" role="button">Tulis Keluhanmu</a>
    ...
    <div class="container">
        <br>
        <h2 class="fw-medium ">Keluhan Lain</h2>
        <br></br>
        @foreach($cerita as $c)
        <div class="row">
            <div class="card mb-4">
